...
source("Fig4_source.R")



# Fig 4: 10X translation
...
# Fig 4: drop to drop, No Cell ID correction
...
# Fig 4: No value space optimization
...
# Fig S3: round trip conversion into smaller information spaces
roundtrip_10x <- read.table("CCdist/Aug2022_10x_roundtrip_CCDist.tsv",header = T)
roundtrip_drop <- read.table("CCdist/Aug2022_Drop_roundtrip_CCDist.tsv",header = T)
roundtrip_quartz <- read.table("CCdist/Aug2022_Quartz_roundtrip_CCDist.tsv",header = T)
roundtrip_split <- read.table("CCdist/Aug2022_SPLiT_to_roundtrip_CCDist.tsv",header = T)
...
g <- diff_rank_sina(rand_ccdist_path = "CCdist/Aug2022_10x_roundtrip_CCDist.tsv",
                    keep = F,
                    colset = my_col,
                    outdir = "sina/",
                    outname="10x",
...
g <- diff_rank_sina(rand_ccdist_path = "CCdist/Aug2022_Drop_roundtrip_CCDist.tsv",
                    keep = F,
                    colset = my_col,
                    outdir = "sina/",
                    outname="drop",
...
g <- diff_rank_sina(rand_ccdist_path = "CCdist/Aug2022_Quartz_roundtrip_CCDist.tsv",
                    keep = F,
                    colset = my_col,
                    outdir = "sina//",
                    outname="quartz",
...
g <- diff_rank_sina(rand_ccdist_path = "CCdist/Aug2022_SPLiT_to_roundtrip_CCDist.tsv",
                    keep = F,
                    colset = my_col,
                    outdir = "sina//",
                    outname="split",
...
#Fig S4: 10X roundtrip to highly complex read structure
